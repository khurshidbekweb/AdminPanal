...
function DashHome() {
  ...
  return (
    <div className="home-page-wrapper d-flex gap-3 flex-wrap">
        <div className={users.data?"users w-25 p-2 border rounded bg-worning bg-success":"d-none"}>
        ...
        <div className="users w-25 p-2 border rounded bg-warning bg-success">
            ...
            <div className="info mt-5 rounded d-flex align-items-center justify-content-between px-3">
              <img className='bg-light rounded-circle p-2' src={Cottage} alt="users" />
        ...
        <div className="users w-25 p-2 border rounded bg-primary">
            ...
            <div className="info mt-5 rounded d-flex align-items-center justify-content-between px-3">
              <img className='bg-light rounded-circle p-2' src={Languages} alt="users" />
        ...
        <div className="users w-25 p-2 border rounded bg-info">
            ...
            <div className="info mt-5 rounded d-flex align-items-center justify-content-between px-3">
              <img className='bg-light rounded-circle p-2' src={Region} alt="users" />
        ...
        <div className="users w-25 p-2 border rounded bg-danger">
            ...
            <div className="info mt-5 rounded d-flex align-items-center justify-content-between px-3">
              <img className='bg-light rounded-circle p-2' src={Place} alt="users" />
        ...
        <div className="users w-25 p-2 border rounded bg-secondary">
            ...
            <div className="info mt-5 rounded d-flex align-items-center justify-content-between px-3">
              <img className='bg-light rounded-circle p-2' src={Comforts} alt="users" />
              <h3 className='text-white fw-bold'>{camforts?.data?.length}</h3>
            </div>
        </div>
        <div className={notification.data?"users w-25 p-2 border rounded bg-worning bg-success":"d-none"}>
            <h2 className='text-white'>Notification</h2>
            <div className="info mt-5 rounded d-flex align-items-center justify-content-between px-3">
              <img className='bg-light rounded-circle p-2' src={Notification} alt="users" />
